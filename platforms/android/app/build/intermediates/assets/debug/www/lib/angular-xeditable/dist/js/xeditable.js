...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'default': {
      ...
      submitTpl:    '<button type="submit" class="button button-positive button-small ion-checkmark"></button>',
      cancelTpl:    '<button type="button" class="button button-assertive button-small ion-android-cancel" ng-click="$form.$cancel()"></button>'
    },
